...
/**
 * Prueba de la clase Cancion, este programa nos compara las conciones que tenemos creadas, nos dice cual
 * es la mas larga y tambien las que vienen a continuación.
 * @author David
 * @version 1.0.2022
 */
...
public class PruebaCancion {
	/**
	 * Estos son algunos de los metodos que usamos:
